...
![Magnetic Encoder Mounted](magnetic_encoder1.JPG)

**Figure 2.** AS5048B magnetic encoder mounted on the prosthetic joint test rig. The encoder PCB is fixed to the stationary support while the diametrically magnetized magnet is attached to the rotating shaft directly above the sensing chip. During operation, the encoder continuously measures the joint angle through the magnetic field generated by the rotating magnet.
